...
// This is safe: NEXT_PUBLIC_SUPABASE_PUBLISHABLE_KEY is designed to be public.
...
window.__SUPABASE_PUBLISHABLE_KEY = ${JSON.stringify(process.env.NEXT_PUBLIC_SUPABASE_PUBLISHABLE_KEY ?? '')};
  `.trim());
}
